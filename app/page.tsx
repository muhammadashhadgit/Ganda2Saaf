...
export default function Home() {
  return (
    <div className="conatiner mx-auto px-4 py-16">
      <section className="text-center mb-20">
        <AnimatedGlobe />
        <h1 className="text-6xl font-bold mb-6 text-gray-800 tracking-tight">
          Ganda-to-Saaf <span className="text-green-600">Waste Management</span>
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
          Join pur community in making waste management more efficient and
          rewarding
        </p>
      ...
      <section className="grid md:grid-cols-3 gap-10 mb-20">
        ...
        <FeatureCard
          icon={Coins}
          title="Earn Rewards"
          description="Get token for your contributions to waste management efforts."
        />
        <FeatureCard
          icon={Users}
